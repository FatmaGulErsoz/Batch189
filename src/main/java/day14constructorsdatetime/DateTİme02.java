...
public class DateTİme02 {
    public static void main(String[] args) {

        //Anlık zamanı nasıl alırız?
        LocalTime myCurrentTime = LocalTime.now();
        System.out.println(myCurrentTime);//13:30:40.272411
    ...
    MMMM ==> August  */
        ...
        //Date objesini fotmatlayalım
        LocalDate date1 = LocalDate.of(2023,8,28);
        ...
        //28/08/2023 formatını oluşturuuz
