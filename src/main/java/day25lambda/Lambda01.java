...
public class Lambda01 {
    public static void main(String[] args) {
        ...
        System.out.println();
        printCubeOfDisttinctOddElements(nums);
        System.out.println();
        printSomOfSquaresOfDistinctEvenElements(nums);
        System.out.println();
    ...
    //729 2248091 3375
    public static void printCubeOfDisttinctOddElements(List<Integer> nums ) {
        nums.
                stream().
                distinct()
                .filter(t -> t % 2 != 0).
    ...
    //456
    public static void printSomOfSquaresOfDistinctEvenElements (List<Integer> nums){
       int sum = nums.
               stream().
               distinct().
               filter(t-> t%2==0).
